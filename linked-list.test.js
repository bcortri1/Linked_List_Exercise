...
describe("removeAt", function() {
  it("removes from 1-item list", function() {
    ...
    let res = lst.removeAt(0);
    expect(res).toBe("a")
    expect(lst.length).toBe(0);
    expect(lst.head).toBe(null);
    expect(lst.tail).toBe(null);
  });
  it("removes head from 2-item list", function() {
  ...
  it("removes tail from 2-item list", function() {
    let lst = new LinkedList(["a", "b"]);

    let res = lst.removeAt(1);
    expect(res).toBe("b")
    expect(lst.length).toBe(1);
  ...
  it("removes from 4-item list", function() {
    let lst = new LinkedList(["a", "b", "c", "d"]);

    let res = lst.removeAt(2);
    expect(res).toBe("c")
    expect(lst.length).toBe(3);
    expect(lst.head.val).toBe("a");
